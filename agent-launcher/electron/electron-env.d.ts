...
export interface IElectronAPI {
  ...
  writezipFile: (fileName: string, folderName: string, data: string, subFolderName?: string) => Promise<string>
  ...
  dockerDeleteImageID: (agentId: string) => Promise<void>
  ...
  modelDelete: (hash: string, agent_name: string, chain_id: string) => Promise<void>
