                    ...
                    <PopoverBody padding={0}>
                        ...
                        >
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.25 3.75H4.25C3.69772 3.75 3.25 4.19772 3.25 4.75V9.75C3.25 10.3023 3.69772 10.75 4.25 10.75H9.25C9.80228 10.75 10.25 10.3023 10.25 9.75V4.75C10.25 4.19772 9.80228 3.75 9.25 3.75Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M20.25 3.75H15.25C14.6977 3.75 14.25 4.19772 14.25 4.75V9.75C14.25 10.3023 14.6977 10.75 15.25 10.75H20.25C20.8023 10.75 21.25 10.3023 21.25 9.75V4.75C21.25 4.19772 20.8023 3.75 20.25 3.75Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M9.25 14.75H4.25C3.69772 14.75 3.25 15.1977 3.25 15.75V20.75C3.25 21.3023 3.69772 21.75 4.25 21.75H9.25C9.80228 21.75 10.25 21.3023 10.25 20.75V15.75C10.25 15.1977 9.80228 14.75 9.25 14.75Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
