...
const BackupPrivateKey = () => {
   ...
   return (
      <Flex className={s.container} h={"100%"} direction={"column"} justifyContent={"center"} alignItems={"center"} gap={"32px"}>
         <Flex direction={"column"} justifyContent={"center"} gap={"16px"} color="white">
            <Text fontSize={"28px"} fontWeight={500} textAlign={"center"}>Back up private key</Text>
            <Text fontSize={"18px"} fontWeight={400} textAlign={"center"} opacity={0.7}>Your private key makes it easy to back up<br/> and restore your account.</Text>
         </Flex>
         <Flex direction={"column"} gap={"12px"} color="white">
            <Flex direction={"column"} gap={"20px"} w={'590px'} borderRadius={"28px"} border={"1px dashed #E1DDDD"} p={"50px 110px"}>
