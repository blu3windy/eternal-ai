...
const AgentTopInfo = () => {
   ...
   const handleClearHistory = useCallback(() => {
      ...
      if ((window as any).clearChatHistory) {
         (window as any).clearChatHistory();
      }
      setInfoTooltipKey(prev => prev + 1);
   }, []);
            ...
            >
               ...
               <Flex gap={'12px'} justifyContent={'space-between'} alignItems={'center'}>
                  ...
                  <Flex gap={'6px'} alignItems={'center'} className={s.content}>
                     ...
                     // showIcon
                     >
                        <Flex cursor={'pointer'} gap={'4px'} alignItems={'center'}>
                           ...
                           {
                              hasNewVersionCode && isInstalled && (
                                 <Image src={`icons/ic-tooltip-red.svg`} width={'20px'} height={'20px'} />
                              )
                           }
                           <Image src={`icons/ic-angle-down-gray.svg`} width={'20px'} height={'20px'} />
                        </Flex>
                     </InfoTooltip>
