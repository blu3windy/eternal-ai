      ...
      >
         ...
         >
            <Flex
               ...
               overflow="hidden"
               position="relative"
               className={!requireInstall ? s.runningWrapper : isRunning ? s.runningWrapper : s.stopWrapper}
            >
               <AutosizeTextarea
                  type="text"
                  ref={chatInputRef}
                  ...
                  placeholder={!requireInstall ? `Ask something` : isRunning ? `Ask something` : `${selectedAgent?.agent_name} is ready!`}
                  // onEnter
                  onKeyDown={(event) => {
