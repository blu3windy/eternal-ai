var MyApp = (function (exports, require$$5, http, https, require$$0) {
    'use strict';
          ...
          request.once("response", resp => {
            ...
            resp.on("end", () => {
              if (headers["content-encoding"] === "gzip" && body) {
                body = getBytes(require$$0.gunzipSync(body));
              }
              resolve({
                statusCode,
                statusMessage,
    ...
    const _computeHmac = function (algorithm, key, data) {
      return require$$5.createHmac(algorithm, key).update(data).digest();
    };
    ...
    const _pbkdf2 = function (password, salt, iterations, keylen, algo) {
      return require$$5.pbkdf2Sync(password, salt, iterations, keylen, algo);
    };
    ...
    const _randomBytes = function (length) {
      return new Uint8Array(require$$5.randomBytes(length));
    };
    ...
    const _sha256 = function (data) {
      return require$$5.createHash("sha256").update(data).digest();
    };
    ...
    */
    ...
    function decryptKeystoreJsonSync(json, _password) {
      ...
      if (params.name === "pbkdf2") {
        ...
        const key = pbkdf2$1(password, salt, count, dkLen, algorithm);
    ...
    function decryptCrowdsaleJson(json, _password) {
      ...
      const key = getBytes(pbkdf2$1(password, password, 2000, 32, "sha256")).slice(0, 16);
...
})({}, require$$5, http, https, require$$0);
